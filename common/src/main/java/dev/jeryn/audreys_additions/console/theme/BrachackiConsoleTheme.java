...
public class BrachackiConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[] {
                ...
                new ControlSpecification(TRControlRegistry.FAST_RETURN.get(), new Vector3f(-0.20f, 0.65f, -0.60f), EntityDimensions.scalable(0.07f, 0.14f)),
                ...
                new ControlSpecification(TRControlRegistry.RANDOM.get(), new Vector3f(-0.74f, 0.51f, 0.52f), EntityDimensions.scalable(0.14f, 0.22f)),
                new ControlSpecification(TRControlRegistry.DIMENSION.get(), new Vector3f(-0.35f, 0.58f, -0.92f), EntityDimensions.scalable(0.29f, 0.14f)),
                ...
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(0.43f, 0.58f, -0.49f), EntityDimensions.scalable(0.14f, 0.07f)),
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(-0.31f, 0.47f, -1.03f), EntityDimensions.scalable(0.36f, 0.14f)),
                ...
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(-0.09f, 0.49f, 1.02f), EntityDimensions.scalable(0.29f, 0.07f)),
