...
public class PertweeConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[] {
                ...
                new ControlSpecification(TRControlRegistry.RANDOM.get(), new Vector3f(-0.13f, 0.65f, -0.74f), EntityDimensions.scalable(0.07f, 0.14f)),
                ...
                new ControlSpecification(TRControlRegistry.INCREMENT.get(), new Vector3f(0.01f, 0.63f, 0.95f), EntityDimensions.scalable(0.07f, 0.22f)),
                ...
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(-0.45f, 0.52f, -1.08f), EntityDimensions.scalable(0.07f, 0.14f)),
                ...
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(-0.74f, 0.65f, -0.09f), EntityDimensions.scalable(0.14f, 0.07f)),
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(-0.63f, 0.65f, -0.33f), EntityDimensions.scalable(0.14f, 0.07f)),
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(-0.69f, 0.56f, -0.87f), EntityDimensions.scalable(0.14f, 0.07f))
        };
    }
