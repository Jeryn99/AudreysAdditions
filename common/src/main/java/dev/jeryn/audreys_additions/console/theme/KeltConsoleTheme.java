...
public class KeltConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[]{
                ...
                new ControlSpecification(TRControlRegistry.THROTTLE.get(), new Vector3f(-0.38f, 0.51f, -0.96f), EntityDimensions.scalable(0.07f, 0.07f)),
                ...
                new ControlSpecification(TRControlRegistry.FAST_RETURN.get(), new Vector3f(0.45f, 0.61f, -0.51f), EntityDimensions.scalable(0.07f, 0.07f)),
                ...
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(0.05f, 0.58f, -0.67f), EntityDimensions.scalable(0.14f, 0.14f)),
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(0.30f, 0.54f, -0.80f), EntityDimensions.scalable(0.11f, 0.11f)),
                ...
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(0.73f, 0.51f, -0.67f), EntityDimensions.scalable(0.07f, 0.07f)),
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(0.82f, 0.51f, -0.49f), EntityDimensions.scalable(0.07f, 0.07f)),
                ...
                new ControlSpecification(TRControlRegistry.FUEL.get(), new Vector3f(0.10f, 0.65f, -0.52f), EntityDimensions.scalable(0.14f, 0.14f)),
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW.get(), new Vector3f(0.19f, 0.58f, -0.67f), EntityDimensions.scalable(0.14f, 0.14f))
        };
    }
