...
public class AUDShellEntryRegistry {
    ...
    public static void init() {
        ...
        ShellModelCollection.registerShellEntry(AudShellRegistry.POLICEBOX_2005.get(), new PoliceBox2005Entry(AUDModelRegistry.policeBox05, AUDModelRegistry.policeBox05Door));
        ShellModelCollection.registerShellEntry(AudShellRegistry.POLICEBOX_1976.get(), new PoliceBox1976Entry(AUDModelRegistry.policeBox76, AUDModelRegistry.policeBox76Door));
