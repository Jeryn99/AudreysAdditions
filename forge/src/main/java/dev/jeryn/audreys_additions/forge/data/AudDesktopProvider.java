...
public class AudDesktopProvider extends DesktopProvider {
    ...
    protected void addDesktops() {
        ...
        addDesktop(new DesktopTheme(
                ...
                TardisRefined.GSON.toJson(Component.literal(MiscHelper.getCleanName("Thornton")).setStyle(Style.EMPTY.withColor(ChatFormatting.BLUE)))
        ));

        addDesktop(new DesktopTheme(
                new ResourceLocation(AudreysAdditions.MODID, "tremas"),
                new ResourceLocation(AudreysAdditions.MODID, "desktop/tremas"),
                TardisRefined.GSON.toJson(Component.literal(MiscHelper.getCleanName("Tremas")).setStyle(Style.EMPTY.withColor(ChatFormatting.BLUE)))
        ));

        addDesktop(new DesktopTheme(
        new ResourceLocation(AudreysAdditions.MODID, "fugitive"),
                new ResourceLocation(AudreysAdditions.MODID, "desktop/fugitive"),
                TardisRefined.GSON.toJson(Component.literal(MiscHelper.getCleanName("Fugitive")).setStyle(Style.EMPTY.withColor(ChatFormatting.BLUE)))
        ));
        ...
        addDesktop(new DesktopTheme(
                ...
                TardisRefined.GSON.toJson(Component.literal(MiscHelper.getCleanName("Rani")).setStyle(Style.EMPTY.withColor(ChatFormatting.BLUE)))
        ));
