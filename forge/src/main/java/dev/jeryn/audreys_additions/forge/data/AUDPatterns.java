...
public class AUDPatterns extends ShellPatternProvider {
    ...
    protected void addPatterns() {
        ...
        quickAdd(AudShellRegistry.POLICEBOX_1966.getId(), "season_13", true);
        ...
        quickAdd(AudShellRegistry.POLICEBOX_1980.getId(), "dimensional", true);

        quickAdd(AudShellRegistry.POLICEBOX_1976.getId(), "default", true);
        quickAdd(AudShellRegistry.POLICEBOX_1976.getId(), "season_16", true);
        quickAdd(AudShellRegistry.POLICEBOX_1976.getId(), "season_17", true);
        quickAdd(AudShellRegistry.POLICEBOX_1976.getId(), "black_orchid", true);

        quickAdd(AudShellRegistry.POLICEBOX_2005.getId(), "default", true);
        quickAdd(AudShellRegistry.POLICEBOX_2005.getId(), "time_war", true);
        ...
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "default", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "acacia", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "bamboo", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "birch", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "cherry", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "crimson", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "jungle", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "mangrove", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "oak", false);
        quickAdd(AudShellRegistry.GRANDFATHER_CLOCK.getId(), "pale", false);
