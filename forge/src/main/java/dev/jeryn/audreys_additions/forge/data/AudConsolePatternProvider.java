...
public class AudConsolePatternProvider extends ConsolePatternProvider {
    ...
    protected void addPatterns() {
      ...
      //  addPatternToDatagen(AudConsoleRegistry.CHRONOTIS.getId(), createWithDefaultSound("chronotis", new PatternTexture(new ResourceLocation(AudreysAdditions.MODID, "textures/blockentity/console/chronotis/chronotis.png"), true)));
        ...
        addPatternToDatagen(AudConsoleRegistry.SILENCE.getId(), createWithDefaultSound("silence_rainbow_obsidian", new PatternTexture(new ResourceLocation(AudreysAdditions.MODID, "textures/blockentity/console/silence/silence_rainbow_obsidian.png"), true)));
